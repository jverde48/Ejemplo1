...
<%@ page import="mx.sintelti.biblioteca.Libro" %>
<!DOCTYPE html>
<html>
	<head>
		...
		<div id="show-libro" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:libroInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${libroInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
